...
class TestVerticalSplitShortcut096(BaseCase):

    def test_vertical_split_shortcut_096(self):
        ...
        widget.click_shortcut_item("纵向分屏")
        time.sleep(0.3)
        widget.input_new_shortcut("ctrl+shift+j")
        time.sleep(0.3)
        ...
        widget.click_shortcut_item("纵向分屏")
        time.sleep(0.3)
        widget.input_new_shortcut("ctrl+shift+m")
        time.sleep(0.3)

        self.hot_key("ctrl+shift+m")
        time.sleep(0.5)
